...
$( function() {
   ...
   window.open("playvideo.php?video="+video,"atarget");
...
foreach($result['Contents'] as $object){
   $value =  $object['Key']; 
   if(strrpos($value,".mp4") > 0 ||strrpos($value,".mp3") > 0 ){ 
      array_push($vids,$value);
   }
...
foreach($result['Contents'] as $object){
   $value =  $object['Key'];
   if(strrpos($value,".3gp") > 0 && strrpos($value,"_new") == 0){                    
      array_push($vids,$value);
   }
...
if(strrpos($value,"_new.3gp") > 0){
  ?><tr bgcolor="green" style="color:#fff"><td>

<?php
} else if(strrpos($value,".mp4") > 0){
?><tr bgcolor="yellow"><td>

<?php
} else if(strrpos($value,".mp3") > 0){
?><tr bgcolor="blue" style="color:#fff"><td>



<?php
} else if(strrpos($value,".3gp") > 0){
?>

<tr bgcolor="red" style="color:#fff"><td>
<?php
}
?>
